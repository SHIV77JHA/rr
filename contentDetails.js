...
function dynamicContentDetails(ob)
{
    ...
    //     let imgTagProductPreviewDiv = document.createElement('img');
    //     imgTagProductPreviewDiv.id = 'previewImg';
    //     imgTagProductPreviewDiv.src = photos[i];  // Your static image URLs
    //     imgTagProductPreviewDiv.onerror = function() {
    //         console.log("Image failed to load: " + this.src);
    //     };
    //     imgTagProductPreviewDiv.onclick = function(event) {
    //         imgTag.src = this.src;  // Update main image on click
    //     };
    //     productPreviewDiv.appendChild(imgTagProductPreviewDiv);
    // }
...
httpRequest.open('GET', 'https://6716259b33bc2bfe40bca00a.mockapi.io/:endpoint'+id, true)
httpRequest.send()  
